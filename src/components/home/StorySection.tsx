  ...
  return (
    <div>
      <section className="grid mx-1 xl:grid-cols-8 my-5 lg:ml-10">
        ...
        <div className="font-display pl-10 pr-10 pt-7 pb-10 xl:p-14 md:col-span-5 xl:col-span-4">
          <div className="grid grid-rows-1 pb-10 text-3xl ">Our Story</div>
          <div className="text-justify grid grid-rows-1 xl:text-xl md:text-sm text-xs mb-5 lg:mb-5 xl:mb-5 ">
            <p>
